...
periph! {
    ...
    GPTIMER {
        ...
        RIS {
            0x20 RoReg;
            TATORIS { RoRoRegFieldBit }
            CAMRIS { RoRoRegFieldBit }
            CAERIS { RoRoRegFieldBit }
            TAMRIS { RoRoRegFieldBit }
            TBTORIS { RoRoRegFieldBit }
            CBMRIS { RoRoRegFieldBit }
            CBERIS { RoRoRegFieldBit }
            TBMRIS { RoRoRegFieldBit }
        }
        MIS {
            0x20 RoReg;
            TATOMIS { RoRoRegFieldBit }
            CAMMIS { RoRoRegFieldBit }
            CAEMIS { RoRoRegFieldBit }
            TAMRIS { RoRoRegFieldBit }
            TBTOMIS { RoRoRegFieldBit }
            CBMMIS { RoRoRegFieldBit }
            CBEMIS { RoRoRegFieldBit }
            TBMMIS { RoRoRegFieldBit }
        }
        ICR {
            0x20 RwReg;
        ...
        TAR {
            0x20 RoReg;
            TAR { RoRoRegFieldBits }
        }
        TBR {
            0x20 RoReg;
            TBR { RoRoRegFieldBits }
        }
        TAV {
            0x20 RwReg;
        ...
        PP {
            0x20 RoReg;
            SIZE { RoRoRegFieldBits }
            CHAIN { RoRoRegFieldBit }
            SYNCNT { RoRoRegFieldBit }
            ALTCLK { RoRoRegFieldBit }
        }
    }
}
